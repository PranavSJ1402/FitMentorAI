...
import { VapiInstance } from "@/lib/vapi";
...
const GenerateProgramPage = () => {
  ...
  // FIXED: Updated to use correct environment variable
  useEffect(() => {
  ...
  useEffect(() => {
    const handleCallStart = () => {
      ...
      setConnecting(false); // FIXED: Set to false when call actually starts
      setCallActive(true);
      setCallEnded(false);
    };
  ...
  const toggleCall = async () => {
    if (callActive) {
      // FIXED: Added try-catch for stop() method
      try {
